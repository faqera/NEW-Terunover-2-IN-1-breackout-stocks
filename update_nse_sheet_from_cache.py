...
4. 🔥 अंत में दोनों Google Apps Script Web Apps को कॉल करके BOT SIGNAL जनरेट करवाती है
...
def main():
    ...
    # 1. Bhavcopy Download करके Cache अपडेट करें
    ...
    # 2. Google Sheet से कनेक्ट करें
    client = get_google_client()
    spreadsheet_id = "1h5DL7tnrNnukH_EzfteoePDSRyfuICdXC3SB367tfEQ"  # आपकी शीट का ID
    ...
    # 3. दोनों टैब्स के D:J कॉलम अपडेट करें
    ...
    # ============================================================
    # 4. 🔥 सबसे आखिर में: दोनों Web Apps को कॉल करके BOT SIGNAL जनरेट करें
    # ============================================================
...
# ============================================================
# 🏃‍♂️ स्क्रिप्ट चलाने का एंट्री पॉइंट
# ============================================================
